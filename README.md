...
The missingness filter script (fasta_nomissing.py) is modified from the priginal by Pontus Skoglund (https://github.com/pontussk/fasta_nomissing.py) that is distributed under a GNU General Public License v3.0. The modification treats IUPAC ambiguity codes as missing data
